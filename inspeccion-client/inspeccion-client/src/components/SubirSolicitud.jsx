...
export default function SubirSolicitud({ onBack, user }) {
    ...
    async function loadObras() {
      try {
        ...
        const lista = snap.docs
          ...
          .map(o => ({ id: o.id, nombre: o.nombre || o.name || 'Sin nombre' }))
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await addDoc(collection(db, 'artifacts', 'sg-darq', 'public', 'data', 'requerimientos'), {
        tipo,
        obraId,
    ...
    <div className="p-4 max-w-md mx-auto pb-16">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <SearchableSelect value={obraId} onChange={e => setObraId(e.target.value)}
            options={obras.map(o => ({ value: o.id, label: o.nombre }))}
            placeholder={loadingObras ? 'Cargando obras...' : 'Seleccioná la obra...'}
